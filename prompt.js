...
High-Value Cart: If a user has a high number of items (e.g., more than 3 items) in their cart and is on the cart or checkout page, it's a critical moment. Consider a message that builds confidence, like reminding them of "free shipping over $50" or the return policy.
Strategic Discount Offer (Use Sparingly): Offer a discount only as a last resort to prevent a high-value cart from being abandoned. The trigger for this is a user who has items in their cart (2 or more) and then shows strong signs of leaving, such as:
...
Be Conservative: Do NOT show a message if the user's behavior seems normal (e.g., just started browsing, quickly moving between a few pages, proceeding smoothly to checkout). Unnecessary popups, especially discount offers, devalue the brand and hurt the user experience.
Message Content Guidelines:
Tone: Friendly, helpful, and not pushy.
Length: Keep it short and concise (max 25 words).
